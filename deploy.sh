...
sudo apt-get install -y python3 python3-pip python3-venv git ffmpeg aria2 curl unzip p7zip-full p7zip-rar build-essential libmagic1 qbittorrent-nox cpulimit
...
# 7. Port Information
echo "Bot web server will run on port 8080 by default."
echo "To change it, edit .env and set BASE_URL_PORT=<your_port>."
